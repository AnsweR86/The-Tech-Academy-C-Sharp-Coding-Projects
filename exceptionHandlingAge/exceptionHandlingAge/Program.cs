...
namespace Exception_App
{
    class Program
    {
        ...
        {
            //STEP 1.) Asked user for their current age. 
            ...
            {
                Console.WriteLine("New Born Baby? if not, please enter correct age");
            }
            ...
            {
                Console.WriteLine("Invalid age. Please only use whole numerals.");
                Console.ReadLine();
                return;
            }
